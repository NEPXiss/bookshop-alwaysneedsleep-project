...
public class DatabaseInitializer {
    public static void initializeDataBase(){
        ...
        Book book5 = new Book("American Prometheus", "Kai Bird & Martin J. Sherwin", ItemGenre.HISTORY, 400, 4, 50, "H1", "americanprometheus.jpg" );
        StoreStorage.getStorage().getShelfMap().put(book5,book5.getItemLocation());
        Book book6 = new Book("A Brief History of Time", "Stephen Hawking", ItemGenre.SCIENCE, 350, 5, 100, "S5", "abriefhistoryoftime.jpg" );
        StoreStorage.getStorage().getShelfMap().put(book6,book6.getItemLocation());
        Book book7 = new Book("Meditation", "Marcus Aurelius", ItemGenre.PHILOSOPHY, 270, 5, 50, "PH2", "meditation.jpg" );
        StoreStorage.getStorage().getShelfMap().put(book7,book7.getItemLocation());
        Book book8 = new Book("Road To Wigan Pier", "George Orwell", ItemGenre.HISTORY, 370, 5, 50, "H2", "roadtowiganpier.jpg" );
        StoreStorage.getStorage().getShelfMap().put(book8,book8.getItemLocation());
        Book book9 = new Book("Letters Of J.R.R Tolkien", "J.R.R Tolkien", ItemGenre.PHILOSOPHY, 470, 5, 50, "H2", "letteroftolkien.jpg" );
        StoreStorage.getStorage().getShelfMap().put(book9,book9.getItemLocation());
        Book book10 = new Book("Faust", "J W Goethe", ItemGenre.FICTION, 170, 4, 20, "L1", "faust.jpg" );
        StoreStorage.getStorage().getShelfMap().put(book10,book10.getItemLocation());
        Book book11 = new Book("Walden", "Henry D. Thoreau", ItemGenre.PHILOSOPHY, 270, 5, 50, "PH1", "walden.jpg" );
        StoreStorage.getStorage().getShelfMap().put(book11,book11.getItemLocation());
        Book book12 = new Book("East Of Eden", "John Steinbeck", ItemGenre.FICTION, 640, 5, 50, "L2", "eastofeden.jpg" );
        StoreStorage.getStorage().getShelfMap().put(book12,book12.getItemLocation());
        Book book13 = new Book("The Brothers Karamazov", "Fyodor Dostoevsky", ItemGenre.FICTION, 870, 5, 50, "PH2", "brotherkaramazov.jpg" );
        StoreStorage.getStorage().getShelfMap().put(book13,book13.getItemLocation());
        Book book14 = new Book("Outlier", "Malcom Gladwell", ItemGenre.PSYCHOLOGY, 550, 5, 50, "PH2", "outlier.jpg" );
